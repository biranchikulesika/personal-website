...
function noteItems(): NoteItem[] {
  return [
    ...
    },
    {
      ...
      description:
        "Giving feedback is an act of attention before it is an act of judgment.",
      content: [
    ...
    },
    {
      ...
      description:
        "Quality is a trade, not a preference. The price is usually time.",
      content: [
  ...
  return [
    {
      ...
      description:
        "How the internet reshapes the way we read, remember, and think.",
      date: "2025",
      tags: ["The web", "Attention"],
    ...
    },
    {
      ...
      author: "Cal Newport",
      description:
        "Focused, distraction-free work as a rare and increasingly valuable craft.",
      date: "2025",
      tags: ["Attention", "Craft"],
    },
    {
      ...
      author: "Neil Postman",
      description:
        "On surrendering culture to technology, efficiency, and invisible ideology.",
      date: "2024",
      tags: ["The web", "Tools"],
      cover:
    ...
    },
    {
      ...
      description:
        "The craft of clear prose, explained with wit, reason, and linguistic evidence.",
      date: "2024",
      tags: ["Craft", "Writing"],
    },
    {
      ...
      description:
        "A classic primer on seeing loops, feedback, and the whole instead of isolated parts.",
      date: "2023",
      tags: ["Systems", "Craft"],
      cover:
    ...
    },
    {
      ...
      author: "Dennis Tenen",
      description:
        "Why the simplest, quietest digital formats may outlast the grandest platforms.",
      date: "2023",
      tags: ["Tools", "The web"],
    },
    {
      ...
      author: "Austin Kleon",
      description:
        "Ten ways to share your creativity and get discovered by being generous with your process.",
      date: "2024",
    ...
    },
    {
      ...
      author: "Don Norman",
      description:
        "Fundamental principles of intuitive usability, affordances, and human-centered design.",
      date: "2023",
      tags: ["Design", "Tools"],
    },
    {
      ...
      description:
        "An inquiry into values, technology, and what it truly means to care about quality.",
      date: "2022",
    ...
    },
    {
      ...
      author: "Nadia Eghbal",
      description:
        "The making and maintenance of open source software and digital commons.",
      date: "2024",
      tags: ["The web", "Tools"],
    },
    {
      ...
      author: "Johann Hari",
      description:
        "Why you can’t pay attention — and how to think about attention as a collective right.",
      date: "2025",
      tags: ["Attention"],
    },
    {
      ...
      author: "Anne Lamott",
      description:
        "Some instructions on writing and life — taking things one small step at a time.",
      date: "2023",
      tags: ["Writing", "Craft"],
    },
  ];
...
export function seedWriting(): SectionGroup<WritingItem> {
  return {
    ...
    href: "/writing",
    subheader:
      "Longer pieces and reflections on the web, craft, and digital life.",
    items: writingItems(),
  };
}
