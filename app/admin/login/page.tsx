        ...
        <div className="flex w-full max-w-xs flex-col items-center">
          ...
          <div className="flex items-center justify-center gap-10">
            <button
              ...
              disabled={loading}
              className="group flex flex-col items-center gap-2 py-3 transition-all disabled:opacity-50"
            >
              {/* Fingerprint in brand color */}
              <svg className="h-8 w-8" viewBox="0 0 24 24" fill="none" stroke="#D97757" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            >
              ...
              <svg className="h-8 w-8" viewBox="0 0 24 24" fill="#FAF9F5" aria-hidden="true">
